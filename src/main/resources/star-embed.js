...
if (typeof DaVinci === "undefined") {
  ...
  DaVinci = {
    createDataLayer: function (datasetURL, serverURL) {
      serverURL = serverURL || "";
      return new ol.layer.Tile({
        source: new ol.source.XYZ({
          url: serverURL + "/dynamic/visualize.cgi/" + datasetURL + '/tile-{z}-{x}-{y}.png',
...
(function (scriptElement) {
  DaVinci.addLoadEvent(function () {
    ...
    layers.push(DaVinci.createDataLayer(dataDatasetName, serverURL));
